...
function setupMain(){
    function spoofQuestion() {
        const phrases = [ "🔥 Get good, get [Khanware](https://github.com/mur1/khanware/)!", "🤍 Made by [@muri](https://fakecrime.bio/muri/).", "☄️ By github.com/mur1/khanware/ " ];
    ...
    function changeBannerText() {
        const phrases = [ "[🌿] Non Skeetless dude.", "[🌿] Khanware on top.", "[🌿] muri said hello!", "[🌿] God i wish i had Khanware.", "[🌿] Get good get Khanware!", "[🌿] the new khanware!" ];
        setInterval(() => { 
